...
const packages = {
  Ekonomi: {
    ...
    materials: [
      ...
      { name: "10 kW LiFePO4 lityum akü (51,2V sistem)", price: 8000 },
  ...
  Performans: {
    ...
    materials: [
      ...
      { name: "15 kW LiFePO4 lityum akü (51,2V sistem)", price: 9000 },
  ...
  Premium: {
    ...
    materials: [
      ...
      { name: "20 kW LiFePO4 lityum akü (51,2V sistem)", price: 12000 },
